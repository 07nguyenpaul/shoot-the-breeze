    ...
    return (
      <div className="message-input">
        ...
        <div className="button-container">
          <Button buttonClass="button-submit" text="Submit" handleClick={() => this.addNewMessage(this.state.draftMessage)} />
          <Button buttonClass="button-clear" text="Clear" handleClick={() => this.clearMessage(draftMessage)} />
        </div>
      </div>
    );
  }
